...
public class Ent_SorView extends JDialog {
	...
	public void cajaEleccion() {
		...
		e_sBox.setBounds(498, 83, 101, 24);
		contentPanel.add(e_sBox);
		
		
		gymBox = new JComboBox();
		gymBox.setModel(new DefaultComboBoxModel(new String[] {"MacFit Olesa", "MacFit Abrera", "MacFit Manresa", "MacFit Castellet"}));
		gymBox.setBounds(498, 48, 101, 24);
	...
	public void calendarios() {
		...
		dateDesde.setBounds(413, 188, 153, 19);
		contentPanel.add(dateDesde);
		
		dateHasta = new JDateChooser();
		dateHasta.setBounds(413, 261, 153, 19);
	...
	public void filtro() {
		...
		rdbtnGimnas = new JRadioButton("Gimnas");
		rdbtnGimnas.setBounds(403, 49, 92, 23);
		contentPanel.add(rdbtnGimnas);

		rdbtnMoviment = new JRadioButton("Moviment");
		rdbtnMoviment.setBounds(403, 84, 92, 23);
		contentPanel.add(rdbtnMoviment);

		rdbtnData = new JRadioButton("Data");
		rdbtnData.setBounds(403, 121, 92, 23);
		...
		btnFiltrar.setBounds(507, 311, 92, 23);
...
//------------------------------------------------------------------------------ELIMINAR
	...
	public void cajasTexto() {
		...
		lblDesde.setBounds(403, 164, 70, 15);
		contentPanel.add(lblDesde);
		
		JLabel lblNewLabel = new JLabel("Hasta:");
		lblNewLabel.setBounds(403, 233, 70, 15);
